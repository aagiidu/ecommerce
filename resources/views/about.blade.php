    ...
    <div class="container aboutus">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 offset-lg-1 col-md-6 padding_bottom_half text-center text-md-left">
                <h2 class="darkcolor font-normal bottom30">Oriental <span class="defaultcolor">NOVA</span></h2>
                <p>
	        		Oriental Nova LLC is an import and export company based in Ulaanbaatar, capital city of Mongolia. Established in 2008, the company is specializing in supplying health and fitness supplements, products and healthy food products into Mongolia. 
	        	</p>
        		<p>
					With the healthy diet trend changing worlwide, we strive to provide better quality supplements and introduce healthy diet concepts for the Mongolian population. 
				</p>
				<p>
					We import fitness and health products from China, India, Japan, Germany into Mongolia. We have become exclusively distribute “Ironmaxx nutrition” fitness supplements from Germany.
				</p>
            </div>
        </div>
        <div class="row">
        	<div class="col-sm-12">
        		<div class="alert gradient-bg whitecolor py-5">
	        		<h2 class="font-normal">Our mission</h2>
	        		<p class="p-0">
						We aim to access technology and to deliver quality products and reliable services to Mongolia, while honoring human health and the environment.
					</p>
				</div>
        	</div>
        </div>
